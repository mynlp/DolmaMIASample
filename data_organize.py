...
if __name__ == "__main__":
    ...
    source_directory = "/NAS/Personal/bwchen/Dolmad_ata/dolma_absolute_filtered_dataset_2"
    # 指定重组后数据存放的目标文件夹
    destination_directory = "/home/bwchen/DolmaMIASample/dolma_dataset_untruncated_2"
